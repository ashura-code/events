export default function Policy() {
  return (
    <div>
      <h1>Privacy Policy for Events</h1>

      <p>
        At Events, accessible from https://www.example.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Events
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Events. This policy is not applicable to any
      ...
      <p>
        Events follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Events uses "cookies". These cookies are used to
      ...
      <p>
        ...
        advertising partners of Events.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Events, which are sent directly
      ...
      <p>
        Note that Events has no access to or control over these cookies that are
      ...
      <p>
        Events's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Events does not knowingly collect any Personal Identifiable Information
